...
$bst_var_ftrop_form_shortcode      = $bst_option_fields['bst_var_ftrop_form_shortcode'] ?? null;
			...
			<div class="footer-widgets d-flex justify-content-between flex-wrap">
				...
				<div class="single-widget newsletter-widget">
					...
					<?php if ( $bst_var_ftrop_text ) { ?>
						<?php echo html_entity_decode( $bst_var_ftrop_text ); ?>
					<?php } ?>
					<?php if ( $bst_var_ftrop_form_shortcode ) { ?>
						<?php echo do_shortcode( html_entity_decode( $bst_var_ftrop_form_shortcode ) ); ?>
					<?php } ?>
				</div>
